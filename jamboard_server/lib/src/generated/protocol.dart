...
import 'user_stream.dart' as _i7;
import 'package:jamboard_server/src/generated/board.dart' as _i8;
import 'package:jamboard_server/src/generated/user_stream.dart' as _i9;
export 'board.dart';
export 'example.dart';
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i7.UserStream) {
      return _i7.UserStream.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i7.UserStream?>()) {
      return (data != null ? _i7.UserStream.fromJson(data) : null) as T;
    }
    if (t == List<_i8.Board>) {
      return (data as List).map((e) => deserialize<_i8.Board>(e)).toList()
          as dynamic;
    }
    if (t == List<_i9.UserStream>) {
      return (data as List).map((e) => deserialize<_i9.UserStream>(e)).toList()
          as dynamic;
    }
    try {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'UserStream') {
      return deserialize<_i7.UserStream>(data['data']);
    }
