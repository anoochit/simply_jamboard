...
--
-- Class UserStream as table user_stream
--
...
--
-- Foreign relations for "user_stream" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('jamboard', '20240704125222440', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240704125222440', "timestamp" = now();
